...
const AddServiceProvider = () => {
    ...
    const Submit = (event) => {
        ...
        axios.post(`api/addServiceProvider`, data).then(response => {
            ...
            if (response.data.validation_errors) {
                ...
                if(response.data.duplicateEmail){
                    ...
                    history.push('/serviceProviderList');
                }
            }
        });
    }
    ...
    return (
        <div className='d-flex justify-content-center align-items-center' style={{ height: "100vh" }}>
            <div>
                ...
                <h3 className='text-center text-uppercase fw-bold'>Add Service Provider</h3>
                    <form onSubmit={Submit}>
                        ...
                        <Link className='btn btn-sm btn-danger px-3 mx-5 mt-4' to="/serviceProviderList">Back </Link>
                    </form>
                </div>
            </div>
        </div>
