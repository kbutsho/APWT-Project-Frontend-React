...
const AddSeller = () => {
    ...
    const Submit = (event) => {
        ...
        axios.post(`api/addSeller`, data).then(response => {
    ...
    return (
        <div className='d-flex justify-content-center align-items-center' style={{ height: "100vh" }}>
            <div>
                ...
                <h3 className='text-center text-uppercase fw-bold'>Add Seller</h3>
                    <form onSubmit={Submit}>
                        ...
                        <Link className='btn btn-sm btn-danger px-3 mx-5 mt-4' to="/sellerList">Back </Link>
                    </form>
                </div>
            </div>
        </div>
