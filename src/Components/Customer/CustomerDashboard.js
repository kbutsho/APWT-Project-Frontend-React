...
const CustomerDashboard = () => {
    ...
    const onSubmit = (event) => {
        ...
        axios.post(`/api/customerPhoto`, data).then(response => {
                ...
                <div className="row" style={{ height: "90vh" }}>
                    ...
                    <div className="col-md-6">
                        <div className="d-flex align-items-center justify-content-center" style={{ height: "90vh" }}>
                            <div className="p-5"
                                style={{ borderRadius: "10px", background: "#EFE3D0", height: "400px", width: "430px", boxShadow: "3px 3px 10px gray" }}>
                                <h4 className="mb-5 fw-bold text-danger text-uppercase">Customer Information</h4>
                                ...
                                <div>
                                    <Link to="/updateCustomerProfile" className="btn btn-danger btn-sm">Edit
                                        Profile</Link>
                                </div>
                            </div>
                        </div>
